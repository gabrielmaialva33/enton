...
class CryptoToolkit:
        ...
        return [
            {
                ...
                "parameters": {
                    ...
                    "properties": {
                        "symbol": {
                            "type": "string",
                            "description": "Símbolo da moeda (ex: bitcoin, ethereum, dogecoin)",
                        }
                    },
                    "required": ["symbol"],
                },
            ...
            },
            {
                ...
                "parameters": {
                    ...
                    "properties": {
                        ...
                        "amount_usd": {
                            "type": "number",
                            "description": "Valor em USD para negociar",
                        },
                    },
    ...
    def check_market_sentiment(self) -> str:
        ...
        status = "Neutro"
        if score < 25:
            status = "Extreme Fear (Hora de comprar?)"
        elif score < 45:
            status = "Fear"
        elif score > 55:
            status = "Greed"
        elif score > 75:
            status = "Extreme Greed (Bolha?)"
    ...
    def execute_paper_trade(self, action: str, symbol: str, amount_usd: float) -> str:
        ...
        if action == "buy":
            if wallet["balance_usd"] < amount_usd:
                return (
                    f"SEM FUNDOS! Saldo: ${wallet['balance_usd']:.2f}, Tentativa: ${amount_usd:.2f}"
                )
