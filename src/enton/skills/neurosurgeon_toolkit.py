...
class NeurosurgeonToolkit:
        ...
        return [
            {
                ...
                "parameters": {
                    ...
                    "properties": {
                        "module_name": {
                            "type": "string",
                            "description": "Nome do módulo (ex: enton.app, enton.core.config)",
                        }
                    },
            ...
            },
            {
                ...
                "parameters": {
                    ...
                    "properties": {
                        "module_name": {
                            "type": "string",
                            "description": "Nome do módulo a ser salvo.",
                        }
                    },
                    "required": ["module_name"],
                },
            },
            {
                ...
                "parameters": {
                    ...
                    "properties": {
                        "module_name": {
                            "type": "string",
                            "description": "Nome do módulo (ex: enton.core.memory)",
                        },
                        "function_name": {
                            "type": "string",
                            "description": "Nome da função/classe a reescrever",
                        },
                        "new_code": {
                            "type": "string",
                            "description": "O novo código completo da função/classe",
                        },
                    },
            ...
            },
            {
                ...
                "parameters": {
                    ...
                    "properties": {
                        "module_name": {
                            "type": "string",
                            "description": "Nome do módulo a recarregar",
                        }
                    },
                    "required": ["module_name"],
                },
            },
            {
                ...
                "parameters": {
                    ...
                    "properties": {
                        "test_path": {
                            "type": "string",
                            "description": "Caminho do teste (ex: tests/core/test_memory.py)",
                        }
                    },
                    "required": ["test_path"],
                },
    ...
    def backup_module(self, module_name: str) -> str:
        file_path = self._get_file_path(module_name)
        if not os.path.exists(file_path):
            return "Erro: Arquivo original não existe."
    ...
    def rewrite_function(self, module_name: str, function_name: str, new_code: str) -> str:
        ...
        try:
            ...
            if not target_node:
                return (
                    f"Erro: Função/Classe '{function_name}' não encontrada no AST de {module_name}."
                )
            ...
            original_indent = lines[start_line][
            ...
            new_lines_indented = [
                original_indent + line if line.strip() else line for line in new_lines_raw
            ]
            ...
            return (
                f"Cirurgia realizada com sucesso em {module_name}.{function_name}. Arquivo salvo."
            )
