...
async def run_command(command: str) -> str:
    ...
    Comandos seguros (ls, cat, ps, docker, git, etc) executam direto.
    Comandos elevados (apt, kill, mount) executam com aviso.
    Comandos perigosos (rm -rf /, mkfs, shutdown) são bloqueados.
    ...
    if level == "dangerous":
        ...
        return f"BLOQUEADO: Comando '{command}' é perigoso demais. Recuso executar isso."
    ...
    try:
        ...
        return f"TIMEOUT: Comando '{command}' excedeu 30 segundos."
